...
/* ─── Tier Definitions ─── */
const TIERS = [
  { key: 'empty',              name: 'Unseeded Chamber', label: 'Unseeded Chamber', zoneSize: 1,  particles: 8,  threshold: 0 },
  { key: 'sanctuary',          name: 'Sanctuary',        label: 'Sanctuary',        zoneSize: 3,  particles: 12, threshold: 1 },
  { key: 'first-archive',      name: 'First Archive',    label: 'First Archive',    zoneSize: 8,  particles: 16, threshold: 4 },
  { key: 'conservatory-wing',  name: 'Conservatory Wing',label: 'Conservatory Wing',zoneSize: 16, particles: 22, threshold: 21 },
  { key: 'botanical-archive',  name: 'Botanical Archive',label: 'Botanical Archive',zoneSize: 28, particles: 28, threshold: 101 },
  { key: 'living-archive',     name: 'Living Archive',   label: 'Living Archive',   zoneSize: 48, particles: 34, threshold: 501 },
];
...
function normalizeSpecimens(data) {
  ...
  const specimens = wings
    ...
    .sort((a, b) => new Date(b.grown_at || 0) - new Date(a.grown_at || 0));
...
/* ═══════════════════════════════════════════════════════════════
   ...
   The environment renders first, the specimens live inside it.
   ═══════════════════════════════════════════════════════════════ */
