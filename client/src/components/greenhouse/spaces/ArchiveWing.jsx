      ...
      <svg className="gh-arch-solid" viewBox="0 0 1600 1200" preserveAspectRatio="none" aria-hidden="true">
        <defs>
          <linearGradient id="wing-floor" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="100%" stopColor="var(--gh-stone-dark)" />
          </linearGradient>

          <linearGradient id="wing-arch-face" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="var(--gh-iron)" />
            <stop offset="10%" stopColor="var(--gh-iron-faint)" />
            <stop offset="90%" stopColor="var(--gh-iron-faint)" />
            <stop offset="100%" stopColor="var(--gh-iron)" />
          </linearGradient>
          
          <linearGradient id="wing-balcony" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="var(--gh-iron-faint)" />
            <stop offset="100%" stopColor="var(--gh-iron)" />
          </linearGradient>
          
          <radialGradient id="wing-dest-glow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="var(--gh-warm)" stopOpacity="0.3" />
        ...
        <path d="M 700,600 L 700,450 A 100,100 0 0 1 900,450 L 900,600 Z" fill="var(--gh-iron-faint)" />
        ...
        <path d="M 300,1200 L 300,500 A 500,250 0 0 1 1300,500 L 1300,1200 Z" fill="var(--gh-glass)" opacity="0.15" />
        {/* Vault Ribs */}
        {[...Array(7)].map((_, i) => {
          const r = 500 - (i * 50);
          if (r <= 0) return null;
          return <path key={`vault-rib-${i}`} d={`M ${800-r},500 A ${r},${r/2} 0 0 1 ${800+r},500`} fill="none" stroke="var(--gh-iron)" strokeWidth="6" />;
        })}
        ...
        {[...Array(8)].map((_, i) => {
          ...
          return <line key={`h-seam-${i}`} x1={x1} y1={y} x2={x2} y2={y} stroke="var(--gh-stone-dark)" strokeWidth="3" opacity="0.6" />;
        })}
        {/* Perspective Lines */}
        <line x1="750" y1="600" x2="300" y2="1200" stroke="var(--gh-stone-dark)" strokeWidth="4" opacity="0.6" />
        <line x1="850" y1="600" x2="1300" y2="1200" stroke="var(--gh-stone-dark)" strokeWidth="4" opacity="0.6" />
        
        {/* Gallery Edge Curbs */}
        <path d="M 600,600 L 0,1200 L 0,1150 L 600,550 Z" fill="var(--gh-stone-base)" />
        <path d="M 1000,600 L 1600,1200 L 1600,1150 L 1000,550 Z" fill="var(--gh-stone-base)" />
        {/* Curb Edge Highlights */}
        <line x1="600" y1="600" x2="0" y2="1200" stroke="var(--gh-stone-light)" strokeWidth="6" />
        <line x1="1000" y1="600" x2="1600" y2="1200" stroke="var(--gh-stone-light)" strokeWidth="6" />

        {/* ── MASSIVE STRUCTURAL BAY ARCH ── */}
        {/* Outer arch base shadow */}
        <path d="M 10,1200 L 10,600 A 790,490 0 0 1 1590,600 L 1590,1200" fill="none" stroke="rgba(0,0,0,0.3)" strokeWidth="40" />
        ...
        <path d="M 175,1200 L 175,600 A 625,325 0 0 1 1425,600 L 1425,1200" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="8" />
        {/* Arch inner shadow depth (gives thickness to the arch) */}
        <path d="M 180,1200 L 180,600 A 620,320 0 0 1 1420,600 L 1420,1200" fill="none" stroke="rgba(0,0,0,0.4)" strokeWidth="25" />
        ...
        {/* Balcony bevels */}
        <rect x="0" y="140" width="1600" height="20" fill="rgba(0,0,0,0.3)" opacity="0.95" />
        <rect x="0" y="80" width="1600" height="4" fill="var(--gh-stone-light)" opacity="0.3" />
        {/* Heavy railing base */}
        <rect x="0" y="30" width="1600" height="20" fill="var(--gh-iron)" />
        {/* Vertical railing posts */}
        {[...Array(65)].map((_, i) => (
          <rect key={`post-${i}`} x={i * 25} y="-20" width="5" height="50" fill="var(--gh-iron-faint)" />
        ))}
        {/* Top rail */}
        <rect x="0" y="-30" width="1600" height="15" fill="var(--gh-iron)" />
      </svg>
